...
<head>
	...
	<title>Sebiotimo Medical Center - Login Page</title>
...
<body class="simple-page" style="background-color: #152265;">
	<div id="back-to-home">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">Sebiotimo Medical Center</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your Login Details </h4>
	...
	<hr />
	<a href="signup.php" style="color: #152265;">Signup/Registration</a>
</div><!-- #login-form -->
